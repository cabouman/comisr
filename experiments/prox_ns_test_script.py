...
if __name__ == "__main__":
    ...
    lambda_param = 0.1              # Seems to become numerically unstable for lambda_param < 0.5
    ...
    desired_shape = tuple(dim // 4 for dim in measured_image.shape)
    ...
    cu.display_image(np.fft.ifftshift(wiener_psf), title='Wiener PSF')
    ...
    cu.display_images(gt_image, prox_image, label1='Ground Truth', label2='Prox Output')
